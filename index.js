...
export const burger = {
  ...
  price: 18, 
  category: "Lunch", 
  discount:function(mass){
    if (mass=="teacher" || mass=="student"){
      return (this.price / 100) * 25;
...
const reviews = [
    ...
    {name: "Reyna", rating: 3.5, feedback: "his place is chill with really cool people, great for getting work done on weekdays"},
]
